export default {
  ...
  admin: {
    ...
    clandes: {
      ...
      oauthTitle: 'Claude OAuth 登录',
      oauthDesc: '通过 clandes 发起 Claude 账号的 OAuth 认证，绕开 IP/指纹摩擦',
      codexOauthTitle: 'Codex OAuth 登录',
      codexOauthDesc: '通过 clandes 发起 OpenAI/ChatGPT 账号的 OAuth 认证',
      oauthRedirectUri: '回调地址 (Redirect URI)',
      oauthStartBtn: '开始登录',
      oauthStarting: '跳转中…',
      oauthCode: '授权码 (code)',
      oauthCallbackUrl: '实际回调 URL (含 code 参数)',
      oauthExchangeBtn: '获取 Token',
      oauthExchanging: '交换中…',
      oauthResult: '登录结果',
      oauthCopy: '复制',
      oauthCopied: '已复制',
      oauthStartFailed: '启动 OAuth 失败',
      oauthExchangeFailed: 'Token 交换失败',
    },
  },
