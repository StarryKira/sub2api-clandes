export default {
  ...
  admin: {
    ...
    clandes: {
      ...
      oauthTitle: 'Claude OAuth Login',
      oauthDesc: 'Initiate Claude account OAuth via clandes, bypassing IP/fingerprint friction',
      codexOauthTitle: 'Codex OAuth Login',
      codexOauthDesc: 'Initiate OpenAI/ChatGPT account OAuth via clandes',
      oauthRedirectUri: 'Redirect URI',
      oauthStartBtn: 'Start Login',
      oauthStarting: 'Redirecting…',
      oauthCode: 'Authorization Code',
      oauthCallbackUrl: 'Actual Callback URL (with code param)',
      oauthExchangeBtn: 'Exchange Token',
      oauthExchanging: 'Exchanging…',
      oauthResult: 'Login Result',
      oauthCopy: 'Copy',
      oauthCopied: 'Copied',
